...
l();n();var f=new WeakMap;d.prototype.set=function(a,b){var c=e(this,a);c.list||(c.list=this.c[c.id]=[]);c.b?c.b.value=b:(c.b={next:this.a,previous:this.a.previous,head:this.a,key:a,value:b},c.list.push(c.b),this.a.previous.next=c.b,this.a.previous=c.b,this.size++);return this};
...
l();n();b.prototype.add=function(a){this.a.set(a,a);this.size=this.a.size;return this};
...
H=Object.freeze(["pkedcjkdefgpdelpbcmbmeomcjbeemfm","fjhoaacokmgbjemoflkofnenfaiekifl"]),I=Object.freeze(".corp.google.com .googlevideo.com .ytimg.com .google.com .googlesyndication.com .gstatic.com .prod.google.com".split(" ")),J=Object.freeze(["chrome-extension","safari-extension","safari-resource","opera"]);function K(){return F.map(function(a){return L(a)}).filter(function(a){return!!a})}
